		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:nutrifitnessweb3@gmail.com">nutrifitnessweb3@gmail.com</a></li>
				</ul>
			</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/born-fruits-semi-dehydrated-pina-caja-8-unidades.jpg" width="280px" height="70px" alt=" " class="img-responsive" /></a>
										...
										<form  target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="G9DZ7JAF7FY9N">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" alt="PayPal - The safer, easier way to pay online!" target="paypal" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
										</form>
										<!--style="display: none;"       action="https://www.paypal.com/cgi-bin/webscr"-->
									</div>
									</div>
								</figure>
							</div>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/born-fruits-semi-dehydrated-platano-caja-8-unidades.jpg" alt=" " class="img-responsive" /></a>
											...
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
												<input type="hidden" name="cmd" value="_s-xclick">
												<input type="hidden" name="hosted_button_id" value="BWYNW2VYS57LS">
												<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
												<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
										</div>									
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/nutrisport-omega-3-caja-100-unidades.jpg" alt=" " class="img-responsive" /></a>
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="E487TQAS33LQ8">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/nutrisport-plus-vital-30-unidades.jpg" alt=" " class="img-responsive" /></a>
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="Q9HZYVK4GYK92">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/nutrisport-sport-pack-antioxidant-30-unidades.jpg" alt=" " class="img-responsive" /></a>
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="X7JB3WYKQ4DPU">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/nutrisport-sport-vitamin-10-unidades.jpg" alt=" " class="img-responsive" /></a>
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="B32PHKFHU66E2">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/nutrisport-vitamin-b-60-unidades.jpg" alt=" " class="img-responsive" /></a>
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
												<input type="hidden" name="cmd" value="_s-xclick">
												<input type="hidden" name="hosted_button_id" value="6TJ9NNDQQ23X8">
												<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
												<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
												</form>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="images/Productos/VitaminasMinerales/nutrisport-vitamin-c-y-e-60-unidades.jpg" alt=" " class="img-responsive" /></a>
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="H5MPU2VW323NL">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
