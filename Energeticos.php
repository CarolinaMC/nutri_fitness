								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="RRVFSWSFR9TQ8">
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="5T668K95G8VCW">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="UV4M9F4EZ4J2A">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="ZYTP79L2YBFAL">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="ZVDWEBUUNDQRQ">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
