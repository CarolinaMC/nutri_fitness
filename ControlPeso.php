								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="59QQ8LVLJKXEG">
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="LWY2P57TVSBBC">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
												<input type="hidden" name="cmd" value="_s-xclick">
												<input type="hidden" name="hosted_button_id" value="ZV95JNUDT5T3J">
												<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
												<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
												</form>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="LL3WFWUACUQFS">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
											<input type="hidden" name="cmd" value="_s-xclick">
											<input type="hidden" name="hosted_button_id" value="AGERZJPKPRPMG">
											<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
											<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
											</form>
