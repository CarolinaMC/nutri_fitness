...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			<div class="w3l_banner_nav_right_bannerProteinas w3l_banner_nav_right_banner_pet">
				<h4>Tus proteinas favoritas</h4>
				<br><br><br><br><br><br><br><br><br><br><br>
				<a href="#">Comprar ahora</a>
			</div>
			<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_sub">
				<h3 class="w3l_fruit">Proteinas</h3>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/dragon-superfoods-organic-calabaza-seed-protein-200gr.jpg" width="280px" height="70px" alt=" " class="img-responsive" /></a>
											<p>Dragon superfoods organic calabaza seed protein (200gm)</p>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="item_name" value="Dragon superfoods organic calabaza seed protein" />
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/nutrisport-iso-whey-bebida-naranja-20gr-12-unidades.jpg" alt=" " class="img-responsive" /></a>
											<p>Nutrisport iso whey bebida naranja (20gm) con 12 unidades</p>
											<h4>$5.00 <span>$6.00</span></h4><br><br>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Nutrisport iso whey bebida naranja" />
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/nutrisport-mega-protein-1.8kg-fresa.jpg" alt=" " class="img-responsive" /></a>
											<p>Nutrisport mega protein sabor a fresa (1.8kg)</p><br>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Nutrisport mega protein sabor a fresa" />
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/nutrisport-ovo-protein-caja-305gr.jpg" alt=" " class="img-responsive" /></a>
											<p>Nutrisport ovo protein caja (305gm)</p><br>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Nutrisport ovo protein caja" />
													<input type="hidden" name="amount" value="18.00" />
													<input type="hidden" name="discount_amount" value="8.00" />
													<input type="hidden" name="currency_code" value="USD" />
													<input type="hidden" name="return" value=" " />
													<input type="hidden" name="cancel_return" value=" " />
													<input type="submit" name="submit" value="Añadir al Carrito" class="button" />
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/nutrisport-protein-plus-bebida-choco-250ml.jpg" alt=" " class="img-responsive" /></a>
											<p>Nutrisport protein plus bebida choco (250ml)</p>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Nutrisport protein plus bebida choco" />
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/nutrisport-vegan-protein-cappuccino-520gr.jpg" alt=" " class="img-responsive" /></a>
											<p>Nutrisport vegan protein cappuccino (520gm)</p>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Nutrisport vegan protein cappuccino" />
													<input type="hidden" name="amount" value="15.00" />
													<input type="hidden" name="discount_amount" value="1.00" />
													<input type="hidden" name="currency_code" value="USD" />
													<input type="hidden" name="return" value=" " />
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="#"><img src="images/Productos/Proteinas/powerbar-proteinplus-whey-vanilla-570gr.jpg" alt=" " class="img-responsive" /></a>
											<p>Powerbar proteinplus whey vanilla (570gm)</p>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Powerbar proteinplus whey vanilla" />
													<input type="hidden" name="amount" value="15.00" />
													<input type="hidden" name="discount_amount" value="1.00" />
													<input type="hidden" name="currency_code" value="USD" />
													<input type="hidden" name="return" value=" " />
