                    ...
                    <div id="tab4" class="tab-grid" style="display: block;">
                        ...
                        <div class="col-md-6">
                            <img class="pp-img" src="images/paypal.png" alt="Image Alternative text" title="Image Title">
                             <p>Importante: Nosotros te redireccionamos a Paypal para que puedas realizar tu compra.</p><a class="btn btn-primary">Pago con Paypal</a>
							 </div>
                        <div class="col-md-6">
                            <form class="cc-form">
                                <div class="clearfix">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="form-group form-group-cc-date">
                                        <label>Válido a travez de</label>
                                        <input class="form-control" placeholder="mm/yy" type="text">
                                    </div>
                                </div>
                                <div class="checkbox checkbox-small">
                                    <label>
                                        <input class="i-check" type="checkbox" checked="">Agregar a mis tarjetas</label>
                                </div>
	...
	<div class="newsletter">
		<div class="container">
			<div class="w3agile_newsletter_left">
				<h3>Suscribirse a nuestro boletín de noticias</h3>
			</div>
			<div class="w3agile_newsletter_right">
				<form action="#" method="post">
					<input type="email" name="Email" value="Correo Electronico" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
